...
// caller-supplied description containing ANSI escapes can't reposition
// the cursor or overwrite the picker frame.
...
// (confirm or cancel) so the calling command's subsequent output
