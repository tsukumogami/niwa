...
A new developer runs `niwa init --from org/config && niwa create && niwa apply`. They get the same hooks, settings, and env as everyone else. No manual per-repo configuration.
